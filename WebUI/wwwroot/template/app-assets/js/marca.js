    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(result, function (key, item) {
                ...
                html += '&lt;td&gt;' + item.txtlocalizacao + '&lt;/td&gt;';
...
function GetbyID(Id) {
    ...
    $('#txtlocalizacao').css('border-color', 'lightgrey');
    $.ajax({
        url: "/Home/GetbyID/" + Id,
        typr: "GET",
        contentType: "application/json;charset=UTF-8",
        ...
        success: function (result) {
            ...
            $('#txtlocalizacao').val(result.Localizacao);
            $('#myModal').modal('show'); 
            $('#btnEditar').show();
            $('#btnSalvar').hide();
        },
...
function validate() {
    ...
    if ($('#txtlocalizacao').val().trim() == "") {
        $('#txtlocalizacao').css('border-color', 'Red');
        isValid = false;
    }
    else {
