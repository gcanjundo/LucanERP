...
namespace DataAccessLayer.RecursosHumanos
{
    public class StatusDAO
    {
        ...
        public StatusDTO Adicionar(StatusDTO dto)
        {
            try
            {
                BaseDados.ComandText = "stp_RH_STATUS_FUNCIONARIO_ADICIONAR";
        ...
        public bool Eliminar(StatusDTO dto)
        {
            try
            {
                BaseDados.ComandText = "stp_RH_STATUS_FUNCIONARIO_EXCLUIR";
        ...
        public List<StatusDTO> ObterPorFiltro(StatusDTO dto)
        {
            ...
            try
            {
                ...
                BaseDados.ComandText = "stp_RH_STATUS_FUNCIONARIO_OBTERPORFILTRO";
                BaseDados.AddParameter("DESCRICAO", dto.Descricao);
                BaseDados.AddParameter("@SIGLA", dto.Sigla);
